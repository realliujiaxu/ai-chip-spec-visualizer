    ...
    chips: [
      {
        ...
        summary: [
          ...
          { label: "TF32 算力", value: "494.5 TFLOPS", hint: "官方标称 989 TFLOPS 为稀疏（with sparsity）数值，表中为稠密值（稀疏的一半）。" },
          { label: "FP32 算力（CUDA / Vector Core）", value: "67 TFLOPS" },
      ...
      },
      {
        ...
        summary: [
          ...
          { label: "BF16 / FP16 算力", value: "2250 TFLOPS", hint: "官方 HGX B200 规格：FP16/BF16 Tensor Core 36 PFLOPS（稀疏，8 卡整机），单卡稠密 2250 TFLOPS。" },
          { label: "TF32 算力", value: "1125 TFLOPS", hint: "官方 HGX B200 规格：TF32 Tensor Core 18 PFLOPS（稀疏，8 卡整机），单卡稠密 1125 TFLOPS。" },
          { label: "FP32 算力（CUDA / Vector Core）", value: "75 TFLOPS", hint: "官方 HGX B200 规格：FP32 600 TFLOPS（8 卡整机），单卡 75 TFLOPS。" },
      ...
      },
      {
        ...
        summary: [
          ...
          { label: "FP8 算力", value: "4500 TFLOPS" },
          { label: "BF16 / FP16 算力", value: "2250 TFLOPS", hint: "官方 HGX B300 规格：FP16/BF16 Tensor Core 36 PFLOPS（稀疏，8 卡整机），单卡稠密 2250 TFLOPS。" },
          { label: "TF32 算力", value: "1125 TFLOPS", hint: "官方 HGX B300 规格：TF32 Tensor Core 18 PFLOPS（稀疏，8 卡整机），单卡稠密 1125 TFLOPS。" },
          { label: "FP32 算力（CUDA / Vector Core）", value: "75 TFLOPS", hint: "官方 HGX B300 规格：FP32 600 TFLOPS（8 卡整机），单卡 75 TFLOPS。" },
      ...
      },
      {
        ...
        summary: [
          ...
          { label: "BF16 / FP16 算力", value: "2500 TFLOPS", hint: "官方 GB300 NVL72 规格：FP16/BF16 Tensor Core 360 PFLOPS（稀疏，72 卡整机），单卡稠密 2500 TFLOPS。" },
          { label: "TF32 算力", value: "1250 TFLOPS", hint: "官方 GB300 NVL72 规格：TF32 Tensor Core 180 PFLOPS（稀疏，72 卡整机），单卡稠密 1250 TFLOPS。" },
          { label: "FP32 算力（CUDA / Vector Core）", value: "83 TFLOPS", hint: "官方 GB300 NVL72 规格：FP32 6 PFLOPS（72 卡整机），单卡约 83 TFLOPS。" },
      ...
      },
      {
        ...
        summary: [
          ...
          { label: "TF32 算力", value: "243 TFLOPS", hint: "Cube（张量核）TF32 算力；含 Vector 的总算力为 273 TFLOPS。" },
          { label: "FP32 算力（CUDA / Vector Core）", value: "30 TFLOPS", hint: "Vector Core 的 FP32 算力。" },
      ...
      },
      {
        ...
        summary: [
          ...
          { label: "TF32 算力", value: "216 TFLOPS", hint: "Cube（张量核）TF32 算力；含 Vector 的总算力为 243 TFLOPS。" },
          { label: "FP32 算力（CUDA / Vector Core）", value: "27 TFLOPS", hint: "Vector Core 的 FP32 算力。" },
      ...
      },
      {
        ...
        summary: [
          ...
          { label: "TF32 算力", value: "189 TFLOPS", hint: "Cube（张量核）TF32 算力；含 Vector 的总算力为 212 TFLOPS。" },
          { label: "FP32 算力（CUDA / Vector Core）", value: "23 TFLOPS", hint: "Vector Core 的 FP32 算力。" },
          { label: "显存容量", value: "96 GB HBM" },
          { label: "显存带宽", value: "4 TB/s" },
          { label: "Host2Device 带宽", value: "PCIe 5.0 128 GB/s（双向）", hint: "昇腾 950 集成 72 Lane HiLink SerDes（18 个 X4 端口），对外提供 PCIe 5.0 x16（与灵衢 UB 共用 4 个端口），双向合计 128 GB/s。" },
          { label: "节点内互联带宽", value: "700 GB/s（双向）", hint: "节点 8 卡内每对 NPU 间互联带宽 100 GB/s（双向），总互联带宽 7 × 100 = 700 GB/s（双向）。" },
